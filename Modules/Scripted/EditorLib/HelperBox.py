...
class HelperBox(object):
  ...
  def __init__(self, parent = None, IsThreeVolume = False):
    ...
    self.UpdateModelLive = UpdateModelLive.UpdateModelLive(self.editUtil, False, IsThreeVolume)
  ...
  def setMerge(self, merge, layoutName):
    ...
    self.UpdateModelLive.setMerge(merge, layoutName)
  ...
  def updateModelsLiveCBoxChanged(self, state):
    if self.updateModelsLiveCBox.checked:
      self.UpdateModelLive.IsBuildLive = True
      self.UpdateModelLive.buildModelForAllLabels()
    else:
      self.UpdateModelLive.IsBuildLive = False
  ...
  def createMasterFrame(self):
    ...
    # update model live button
    self.updateModelsLiveCBox = qt.QCheckBox("Update Models Live", self.CheckBoxesFrame)
    self.updateModelsLiveCBox.objectName = 'UpdateModelsLiveCBox'
    self.updateModelsLiveCBox.setToolTip("Updates the model authomatically during the segmentation. Note, this might slow down the process.")
    self.updateModelsLiveCBox.setChecked(False)
    self.updateModelsLiveCBox.connect("stateChanged(int)", self.updateModelsLiveCBoxChanged)
    self.CheckBoxesFrame.layout().addWidget(self.updateModelsLiveCBox)
  ...
  def initialise(self):
    ...
    self.UpdateModelLive.cleanup()
    self.updateModelsLiveCBox.checked = False
  ...
  def threeVolumesCBoxChanged(self, state = None):
    ...
    self.UpdateModelLive.IsThreeVolumes = self.threeVolumesCBox.checked
